         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="min" class="input" required>
                  ...
                  <option value="300000">Rp 200000</option>
                  <option value="500000">Rp 500000</option>
                  <option value="1000000">Rp 1000000</option>
                  <option value="3000000">Rp 3000000</option>
                  <option value="5000000">Rp 5000000</option>
                  <option value="10000000">Rp 10000000</option>
                  <option value="30000000">Rp 30000000</option>
                  <option value="50000000">Rp 50000000</option>
                  <option value="100000000">Rp 100000000</option>
                  <option value="300000000">Rp 300000000</option>
                  <option value="500000000">Rp 500000000</option>
                  <option value="1000000000">Rp 1000000000</option>
                  <option value="3000000000">Rp 3000000000</option>
                  <option value="5000000000">Rp 5000000000</option>
                  <option value="10000000000">Rp 10000000000</option>
                  <option value="20000000000">Rp 20000000000</option>
                  <option value="30000000000">Rp 30000000000</option>
                  <option value="50000000000">Rp 50000000000</option>
               </select>
            </div>
            <div class="box">
               <p>Maximum budget</p>
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><i class="fas fa-rupiah-sign"></i><span><?= $fetch_property['price']; ?></span></div>
