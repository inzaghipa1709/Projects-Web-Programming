...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fas fa-rupiah-sign"></i><span><?= $fetch_property['price']; ?></span></p>
         <p><i class="fas fa-user"></i><span><?= $fetch_user['name']; ?></span></p>
         <p><i class="fas fa-phone"></i><a href="tel:081111111"><?= $fetch_user['number']; ?></a></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>Deposit amount : </i><span><span class="fas fa-rupiah-sign" style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
